...
import 'package:crypto_tutorial/repositories/base_crypto_repository.dart';
...
class CryptoRepository extends BaseCryptoRepository {
  ...
  Future<List<Coin>> getTopCoins({int page}) async {
    List<Coin> coins = [];
    String requestUrl = '$_baseUrl/data/top/totalvolfull?limit=$perPage&tsym=IDR&page=$page';
    try {
